...
// ── SERVICES title — starts large/overflowing, shrinks as you scroll ─────────
  ...
  return (
    <main className="bg-[var(--color-bg)] min-h-screen text-[var(--color-fg)] font-medium overflow-x-hidden">
      ...
      <section className="relative h-screen">
        ...
        {/* Hero text — same position as index/about page */}
        <div className="absolute z-10 px-[30px] mt-[70px]" style={{ top: '72px' }}>
          <p className="text-[23px] w-[355px] leading-normal whitespace-pre-wrap">
            ...
            <Chars text="OFFER" />
            <Chars text=" A FULL RANGE OF SERVICES." className="underline" />
            <Chars text=" FROM DESIGN TO DEVELOPMENT ||               STRATEGY TO GROWTH || " />
            <Chars text="EVERYTHING YOU NEED." className="underline" />
            <Chars text={" OUR MOTTO AND CREED IS SIMPLE. "} />
            <Chars text="WE SERVE:" className="underline" />
          </p>
          <img
            src="/images/shape1.svg"
            alt=""
            className="absolute theme-invert"
            style={{ bottom: '303px', left: '95px' }}
          />
          <p className="text-[var(--color-muted)] text-[17px] mt-8">YOUR PEOPLE</p>
        </div>
      ...
      {/* ── SERVICES CARDS (6 cards — same section used on the homepage) ── */}
      <div className="mt-[200px]">
        <ServicesSection />
      </div>

      {/* ── WALL VIDEO — square crop that reveals to full on scroll ── */}
      <WallRevealImage
        videoSrc="https://matte-cdn.b-cdn.net/collagePortfolio.mp4"
        caption={null}
      />
